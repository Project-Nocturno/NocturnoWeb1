    ...
    <body>
		...
		<center>
			<div class="bloc">
				...
				<form action="verif_login.php" method="post" class="form" autocomplete="off">
					<div class="email-login">
					  <input type="text" name="uname"  required="required" class="email" placeholder="Pseudo...">
					</div>
					<div class="password-login">
					  <input type="password" class="password" name="password" required="required" placeholder="Mot de passe...">
					</div>
					<div class="login-connec">
					  <input type="submit" class="connecte" value="Se connecter">
					</div>
				</form>
			</div>
		</center>
